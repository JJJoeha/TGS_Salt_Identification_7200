...
object UNET {
  ...
  def graphBuilder(seed:Long) : ComputationGraphConfiguration.GraphBuilder = {
    ...
    builder
      .addLayer("conv1-1", new ConvolutionLayer.Builder(3, 3).stride(1, 1).nOut(initFilterNum)
        .convolutionMode(ConvolutionMode.Same)
        .activation(Activation.RELU).build(), "input")
      .addLayer("conv1-2", new ConvolutionLayer.Builder(3, 3).stride(1, 1).nOut(initFilterNum)
        .convolutionMode(ConvolutionMode.Same)
      ...
      .addLayer("conv2-1", new ConvolutionLayer.Builder(3, 3).stride(1, 1).nOut(initFilterNum*2)
        .convolutionMode(ConvolutionMode.Same)
        .activation(Activation.RELU).build(), "pool1")
      .addLayer("conv2-2", new ConvolutionLayer.Builder(3, 3).stride(1, 1).nOut(initFilterNum*2)
        .convolutionMode(ConvolutionMode.Same)
      ...
      .addLayer("conv3-1", new ConvolutionLayer.Builder(3, 3).stride(1, 1).nOut(initFilterNum*4)
        .convolutionMode(ConvolutionMode.Same)
        .activation(Activation.RELU).build(), "pool2")
      .addLayer("conv3-2", new ConvolutionLayer.Builder(3, 3).stride(1, 1).nOut(initFilterNum*4)
        .convolutionMode(ConvolutionMode.Same)
      ...
      .addLayer("conv4-1", new ConvolutionLayer.Builder(3, 3).stride(1, 1).nOut(initFilterNum*8)
        .convolutionMode(ConvolutionMode.Same)
        .activation(Activation.RELU).build(), "pool3")
      .addLayer("conv4-2", new ConvolutionLayer.Builder(3, 3).stride(1, 1).nOut(initFilterNum*8)
        .convolutionMode(ConvolutionMode.Same)
      ...
      .addLayer("up6-2", new ConvolutionLayer.Builder(2, 2).stride(1, 1).nOut(initFilterNum*8)
        .convolutionMode(ConvolutionMode.Same)
        .activation(Activation.RELU).build(), "up6-1")
      .addVertex("merge6", new MergeVertex(), "drop4", "up6-2")
      .addLayer("conv6-1", new ConvolutionLayer.Builder(3, 3).stride(1, 1).nOut(initFilterNum*8)
        .convolutionMode(ConvolutionMode.Same)
        .activation(Activation.RELU).build(), "merge6")
      .addLayer("conv6-2", new ConvolutionLayer.Builder(3, 3).stride(1, 1).nOut(initFilterNum*8)
        .convolutionMode(ConvolutionMode.Same)
      ...
      .addLayer("conv7-1", new ConvolutionLayer.Builder(3, 3).stride(1, 1).nOut(initFilterNum*4)
        .convolutionMode(ConvolutionMode.Same)
        .activation(Activation.RELU).build(), "merge7")
      .addLayer("conv7-2", new ConvolutionLayer.Builder(3, 3).stride(1, 1).nOut(initFilterNum*4)
        .convolutionMode(ConvolutionMode.Same)
        .activation(Activation.RELU).build(), "conv7-1")

      // up8
      .addLayer("up8-1", new Upsampling2D.Builder(2).build(), "conv7-2")
      .addLayer("up8-2", new ConvolutionLayer.Builder(2, 2).stride(1, 1).nOut(initFilterNum*2)
        .convolutionMode(ConvolutionMode.Same)
        .activation(Activation.RELU).build(), "up8-1")
      .addVertex("merge8", new MergeVertex(), "conv2-2", "up8-2")
      .addLayer("conv8-1", new ConvolutionLayer.Builder(3, 3).stride(1, 1).nOut(initFilterNum*2)
        .convolutionMode(ConvolutionMode.Same)
        .activation(Activation.RELU).build(), "merge8")
      .addLayer("conv8-2", new ConvolutionLayer.Builder(3, 3).stride(1, 1).nOut(initFilterNum*2)
        .convolutionMode(ConvolutionMode.Same)
      ...
      .addLayer("conv9-1", new ConvolutionLayer.Builder(3, 3).stride(1, 1).nOut(initFilterNum)
        .convolutionMode(ConvolutionMode.Same)
        .activation(Activation.RELU).build(), "merge9")
      .addLayer("conv9-2", new ConvolutionLayer.Builder(3, 3).stride(1, 1).nOut(initFilterNum)
        .convolutionMode(ConvolutionMode.Same)
